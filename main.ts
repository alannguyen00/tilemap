...
function buildLevel () {
    ...
    // Places player in position when touching orange
    // tile.
    for (let value of scene.getTilesByType(4)) {
        value.place(player1)
    }
    // Changes the tile map to the next level in the array
    // of tiles.
    nextLevel += 1
}
...
3 3 3 3 3 3 3 3 3 3 
`]
// It makes the green block look like a face and
// creates a wall.
scene.setTile(7, img`
...
7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 7 
`, true)
// Starts a number for next level
nextLevel = 0
